...
import com.doracrypto.crypto.databinding.ActivityFeedbackBinding
import com.doracrypto.crypto.http.feedback.FeedbackService
import com.doracrypto.crypto.http.feedback.ReqFeedback
...
import com.doracrypto.crypto.http.SecureRequestBuilder
        ...
        binding.titlebar.addMenuButton(R.drawable.ic_save)
            .setOnIconClickListener(object : DoraTitleBar.OnIconClickListener {
                ...
                override fun onIconMenuClick(position: Int, icon: AppCompatImageView) {
                    ...
                    net {
                        val req = ReqFeedback(productName = "cryptotools",
